...
function flatsome_posted_on() {
    ...
    $posted_on = sprintf(
        ...
        esc_html_x( 'Được xuất bản vào %s', 'post date', 'flatsome' ),
    ...
    $byline = sprintf(
        ...
        esc_html_x( 'bới tác giả %s', 'post author', 'flatsome' ),
        '<span class="meta-author vcard"><a class="url fn n text-warning text-bold" href="' . esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ) . '">' . esc_html( get_the_author() ) . '</a></span>'
    );
