...
<section class="no-results not-found">
	<header class="page-title">
		<h1 class="page-title"><?php esc_html_e( 'Không tìm thấy dữ liệu nào', 'flatsome' ); ?></h1>
	</header>
	...
	<div class="page-content">
		...
		<?php else : ?>
			...
			<p><?php esc_html_e( 'Dường như chúng tôi không thể tìm thấy điều bạn đang mong đợi. Hãy thử dùng thanh tìm kiếm bên dưới và thử lại. Xin cảm ơn!', 'flatsome' ); ?></p>
			<?php get_search_form(); ?>
